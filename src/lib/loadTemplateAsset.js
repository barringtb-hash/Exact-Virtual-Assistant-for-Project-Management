export async function loadTemplateAsset(relPath) {
  ...
  const baseRaw = typeof import.meta !== "undefined" && import.meta.env?.VITE_TEMPLATE_BASE_URL
    ? import.meta.env.VITE_TEMPLATE_BASE_URL
    : "/templates/";
