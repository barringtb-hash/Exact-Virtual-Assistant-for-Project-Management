...
- **Reference map** – a quick codemap for the UI lives inline in [`src/App.jsx`](src/App.jsx) comments near the component definitions, and the charter assets the client references are all located under [`templates/`](templates/).
