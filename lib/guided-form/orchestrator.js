 ...
 */
export function createInitialState(docType, schema) {
  return {
    doc_type: docType,
 ...
 */
export function getCurrentField(state, schema) {
 ...
 */
export async function processMessage(conversationState, userMessage, docType = 'charter') {
  try {
    // Load schema
