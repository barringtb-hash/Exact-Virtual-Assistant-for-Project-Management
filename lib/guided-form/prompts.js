 ...
 */
const SYSTEM_PROMPT = `You are a structured form assistant helping project managers complete a Project Charter document.
 ...
 */
function buildDeveloperPrompt(field, conversationState, action) {
  const context = {
    current_field: field ? {
      id: field.id,
      label: field.label,
 ...
 */
function buildUserMessage(userInput, previousAssistantMessage = null) {
 ...
 */
function formatConfirmation(field, value) {
 ...
 */
function formatValidationError(field, errors) {
 ...
 */
function formatPreview(preview, schema) {
 ...
 */
function formatEndReview(review, schema) {
 ...
 */
function buildClaudePrompts(field, conversationState, action, userInput, previousAssistantMessage = null) {
  return {
